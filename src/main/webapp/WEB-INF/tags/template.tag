...
<html>
    ...
    <body class="skin-1">
            ...
            <nav class="navbar-default navbar-static-side" role="navigation">
                <div class="sidebar-collapse">
                    <ul class="nav metismenu" id="side-menu">
                        <li class="nav-header">
                            <div class="dropdown profile-element center-orientation"> 
                                <span>
                                ...
                                <a data-toggle="dropdown" class="dropdown-toggle" href="#">
                                    <span class="clear"> <span class="block m-t-xs"> <strong class="font-bold">${trust.name}</strong>
                                        </span> <span class="text-muted text-xs block">${account.firstName} ${account.lastName} <b class="caret"></b></span> </span> 
                                </a>
                        ...
                        <li>
                            <a href="layouts.html"><i class="fa fa-building-o"></i> <span class="nav-label">Copropriété</span></a>
                        </li>
                        <li>
        ...
        <!-- jQuery UI -->
        <script src="${pageContext.request.contextPath}/resources/theme_2/assets/js/plugins/jquery-ui/jquery-ui.min.js"></script>
