                ...
                <div class="col-lg-10 animated fadeInRight">
                    <div class="ibox float-e-margins"> 
                        <div class="ibox-content mailbox-content">
                            <ul class="nav nav-pills" >
                                ...
                                <li class="list-group">
                                    <a href="${pageContext.request.contextPath}/owner/message/delete"> 
                    ...
                    <div class="mail-box-header">
                        <div class="pull-right tooltip-demo">
                            <a class="btn btn-sm btn-white" href="${pageContext.request.contextPath}/owner/message/new"><i class="fa fa-reply"></i> <spring:message code="Mview.answer"/></a>
                            <a class="btn btn-sm btn-white" href="${pageContext.request.contextPath}/owner/message/delete/${message.id}"><i class="fa fa-trash-o"></i> Corbeille</a>
                        </div>
                        <h2>
