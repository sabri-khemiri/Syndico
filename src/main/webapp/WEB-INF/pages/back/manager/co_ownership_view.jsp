                    ...
                    <div class="ibox float-e-margins">
                        ...
                        <div>
                            ...
                            <div class="ibox-content profile-content">
                                ...
                                <span class="small text-center"><a href="${pageContext.request.contextPath}/manager/co_ownership/update/image/">Modifier image</a></span>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="tabs-container col-lg-8">
                    ...
                    <div class="tab-content">
                                        ...
                                        <tbody>
                                            <c:forEach var="owner" items="${coOwnership.owners}">
                                                <tr class="gradeX">
                                                    ...
                                                    <td>${owner.enabled == true ? "ACTIF" : owner.username}</td>
                                                    <td>${owner.enabled == true ? "ACTIF" : owner.password}</td>
                                                ...
                                                <tr class="gradeX">
                                                    ...
                                                    <td class="text-center">
                                                        <c:if test="${meeting.report != null}">
                                                            ...
                                                            <a href="${pageContext.request.contextPath}/manager/meeting/update/${meeting.id}"><i class="fa fa-edit" style="color: green"></i></a>
                                                    </td>
                                                </tr>
                                            </c:forEach>
                                        </tbody>
                        ...
                        <div id="tab-4" class="tab-pane">
                            <div class="panel-body">
                                <span class="row">
                                    <a href="${pageContext.request.contextPath}/manager/works/small/add">
                                            ...
                                            <c:forEach var="work" items="${coOwnership.works}">
                                                <tr class="gradeX">
                                                    ...
                                                    <td class="text-center">
                                                        ...
                                                        <a><i class="fa fa-edit" style="color: green"></i></a>
