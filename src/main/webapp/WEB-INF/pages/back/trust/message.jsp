                        ...
                        <div class="ibox-content mailbox-content">
                            <div class="file-manager">
                                ...
                                <ul class="folder-list m-b-md" style="padding: 0">
                                    <li><a href="${pageContext.request.contextPath}/trust/message"> <i class="fa fa-inbox "></i> <spring:message code="Tmsg.inbox"/> <span class="label label-warning pull-right">${fn:length(account.messageReceived)}</span> </a></li>
                                    ...
                                    <li><a href=""> <i class="fa fa-trash-o"></i> <spring:message code="Tmsg.trash"/></a></li>
                                </ul>
                            ...
                            <tbody>
                                <c:forEach var="message" items="${account.messageReceived}">
                                    <tr class="${message.status == "NON_LU" ? "unread" : "read"}"/>
                                        ...
                                        <td class="mail-ontact"><a href="${pageContext.request.contextPath}/trust/message/view/${message.id}">${message.sender.firstName}  ${message.sender.lastName}</a></td>
