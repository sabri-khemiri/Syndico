        ...
        <div class="row wrapper border-bottom white-bg page-heading">
            <div class="col-lg-10">
                ...
                <ol class="breadcrumb">
                    ...
                    <li>
                        <a href="${pageContext.request.contextPath}/trust/profil">Profil</a>
                    </li>
                    <li class="active">
                        ...
                        <div class="ibox-content">
                            <div class="row">
                                <div class="col-lg-offset-1 col-lg-10">
                                    <form method="POST" action="${pageContext.request.contextPath}/trust/profil/image/upload?${_csrf.parameterName}=${_csrf.token}" enctype="multipart/form-data">
