                    ...
                    <div class="mail-box">
                        <div class="mail-body">
                            <form:form role="form" class="form-horizontal" commandName="news" method="POST">
                                <div class="form-group"><label class="col-sm-2 control-label">Copropriété :</label>
                                    <div class="col-sm-10"><form:select path="coOwnership.id" items="${list}" class="form-control">  </form:select></div>
                                    </div>
